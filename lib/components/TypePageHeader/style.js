...
var title = exports.title = (0, _styledComponents.css)(_templateObject2, (0, _utils.extRem)(44), function (props) {
  return props.breakpointsStatus[_breakpoints.MD] ? _typography2.default.header3 : _typography2.default.header4;
}, neutral.higher, (0, _utils.extRem)(-3));

var main = exports.main = (0, _styledComponents.css)(_templateObject3, function (props) {
  return props.breakpointsStatus[_breakpoints.SM] && '\n    display: inline-block;\n    padding-right: ' + (0, _utils.extRem)(64) + ';\n  ';
});
