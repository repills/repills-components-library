...
var base = exports.base = (0, _styledComponents.css)(_templateObject, (0, _utils.extRem)(24, 16), neutral.medium, function (props) {
  return props.checked ? neutral.lower : neutral.lowest;
}, neutral.highest, function (props) {
  return props.checked ? 'block' : 'none';
}, (0, _utils.extRem)(4), status.ok, neutral.lowest, (0, _polished.rgba)(neutral.highest, 0.02));
