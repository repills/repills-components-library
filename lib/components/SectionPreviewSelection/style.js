...
var base = exports.base = (0, _styledComponents.css)(_templateObject, (0, _utils.extRem)(24, 16), neutral.medium, neutral.lowest, neutral.highest, (0, _polished.rgba)(neutral.highest, 0.02), function (props) {
  return props.checked && '\n\n  ';
}, function (props) {
  return props.checked ? 'block' : 'none';
}, (0, _utils.extRem)(4), status.ok);

var icon = exports.icon = (0, _styledComponents.css)(_templateObject2, (0, _polished.size)((0, _utils.extRem)(52)));
