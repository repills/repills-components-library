...
var title = exports.title = (0, _styledComponents.css)(_templateObject3, _typography2.default.header2, neutral.lowest, basic.primary, function (props) {
...
var description = exports.description = (0, _styledComponents.css)(_templateObject5, _typography2.default.body, neutral.medium, (0, _utils.extRem)(650), (0, _utils.extRem)(48), function (props) {
  return props.breakpointsStatus[_breakpoints.MD] && '\n      margin: ' + (0, _utils.extRem)(48) + ' auto 0;\n  ';
});

var typeList = exports.typeList = (0, _styledComponents.css)(_templateObject6, (0, _utils.extRem)(40), (0, _utils.extRem)(20), function (props) {
  return props.breakpointsStatus[_breakpoints.MD] && '\n    justify-content: center;\n    \n    > div + div {\n      margin-left: ' + (0, _utils.extRem)(32) + ';\n    }\n  ';
});

var typeBlock = exports.typeBlock = (0, _styledComponents.css)(_templateObject7, basic.primaryHighest, _typography2.default.mini, neutral.medium, (0, _utils.extRem)(12));

var logo = exports.logo = (0, _styledComponents.css)(_templateObject8, function (props) {
