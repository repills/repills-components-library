...
exports.logo = exports.typeBlock = exports.typeList = exports.pill = exports.pillsAnimation = exports.description = exports.subTitle = exports.title = exports.base = undefined;
...
var typeList = exports.typeList = (0, _styledComponents.css)(_templateObject8, (0, _utils.extRem)(52), (0, _utils.extRem)(20), function (props) {
  return props.breakpointsStatus[_breakpoints.MD] && '\n    justify-content: center;\n    margin-top: ' + (0, _utils.extRem)(52) + ';\n    \n    > div + div {\n      margin-left: ' + (0, _utils.extRem)(32) + ';\n    }\n  ';
});

var typeBlock = exports.typeBlock = (0, _styledComponents.css)(_templateObject9, basic.primaryHighest, _typography2.default.mini, neutral.medium, (0, _utils.extRem)(12));

var logo = exports.logo = (0, _styledComponents.css)(_templateObject6, function (props) {
