...
var title = exports.title = (0, _styledComponents.css)(_templateObject3, _typography2.default.header3, neutral.high, function (props) {
  return props.breakpointsStatus[_breakpoints.LG] && '\n    ' + _typography2.default.header2 + '\n    font-weight: 400;\n  ';
});

var description = exports.description = (0, _styledComponents.css)(_templateObject4, _typography2.default.body, neutral.medium);
...
var typeBlock = exports.typeBlock = (0, _styledComponents.css)(_templateObject6, basic.primaryHighest, _typography2.default.mini, neutral.medium);
