...
var body = exports.body = (0, _styledComponents.css)(_templateObject5, _typography2.default.body, (0, _utils.extRem)(16, 0, 28), neutral.medium, function (props) {
  return props.breakpointsStatus[_breakpoints.SM] && '\n    padding: ' + (0, _utils.extRem)(14, 0, 28, 32) + ';\n    border-left: ' + (props.last ? 0 : '1px dotted ' + neutral.medium) + ';\n    margin: ' + (0, _utils.extRem)(2, 0, 2, 19) + ';\n    \n    ' + (props.last && '\n      margin-left: ' + (0, _utils.extRem)(20) + ';\n    ') + '\n  ';
});