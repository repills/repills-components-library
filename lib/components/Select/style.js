...
var selected = exports.selected = (0, _styledComponents.css)(_templateObject2, neutral.lowest, function (props) {
  return sizes[props.size].height;
}, function (props) {
  return sizes[props.size].sideSpace;
}, neutral.low, function (props) {
  return props.filled ? neutral.highest : neutral.medium;
}, function (props) {
  ...
  return props.disabled ? neutral.medium : neutral.high;
}, function (props) {
...
var item = exports.item = (0, _styledComponents.css)(_templateObject5, neutral.highest, neutral.lowest, neutral.low, function (props) {
  return sizes[props.size].sideSpace;
}, function (props) {
