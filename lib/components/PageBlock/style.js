...
var body = exports.body = (0, _styledComponents.css)(_templateObject5, _typography2.default.body, neutral.high, (0, _utils.extRem)(28), function (props) {
  return !props.simple && '\n    border-top: 1px solid ' + neutral.low + ';\n    padding-top: ' + (0, _utils.extRem)(28) + ';\n  ';
});