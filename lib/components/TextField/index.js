  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          size = _props.size,
          type = _props.type,
          others = _objectWithoutProperties(_props, ['disabled', 'expanded', 'handleOnBlur', 'handleOnFocus', 'handleOnChange', 'hasError', 'name', 'placeholder', 'readOnly', 'required', 'size', 'type']);
...
TextField.propTypes = {
  ...
  type: (0, _propTypes.oneOf)(['text', 'number', 'url', 'date', 'datetime', 'email']),
