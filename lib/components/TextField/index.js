...
var TextField = function TextField(_ref) {
  ...
  return _react2.default.createElement(
    ...
    hasIcon && _react2.default.createElement(
      ...
      hasError ? _react2.default.createElement(_basic.ErrorIcon, { size: iconSize[size] }) : _react2.default.createElement(_basic.CheckIcon, { size: iconSize[size] })
    ),
...
TextField.propTypes = {
  ...
  type: (0, _propTypes.oneOf)(['text', 'number', 'url']),
