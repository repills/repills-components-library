...
function TypeSquarePreview(_ref) {
  var active = _ref.active,
      ...
      others = _objectWithoutProperties(_ref, ['active', 'color', 'basePath', 'count', 'icon', 'id', 'label', 'navigateTo']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(Icon, { size: 36 })
    ),
    _react2.default.createElement(
      TextStyle,
      null,
...
exports.default = TypeSquarePreview;