  ...
  _createClass(ResourcesListWithDetail, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['breakpointsStatus', 'resources', 'dateType', 'navigateToSection', 'navigateToTopic', 'showAllAction', 'navigateToDetail', 'generateDetailUrl']);
