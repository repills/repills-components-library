...
function TopNavigation(_ref) {
  ...
  var loadingStatus = breakpointsStatus ? Object.keys(breakpointsStatus).length === 0 : false;

  return _react2.default.createElement(
    BaseStyle,
    others,
    loadingStatus && _react2.default.createElement(_Spinner2.default, { position: 'absolute' }),
