...
function ResourceDetail(_ref) {
  var color = _ref.color,
      ...
      others = _objectWithoutProperties(_ref, ['color', 'title', 'author', 'link', 'createdAt', 'publishedAt', 'sections', 'topics', 'typeLabel', 'navigateTo', 'suggestedBy', 'navigateToSection', 'navigateToTopic']);
