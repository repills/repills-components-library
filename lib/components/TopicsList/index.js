...
var _TopicExtendedPreview = require('../TopicExtendedPreview');

var _TopicExtendedPreview2 = _interopRequireDefault(_TopicExtendedPreview);
...
var TopicsList = function (_React$Component) {
  ...
  function TopicsList(props) {
    ...
    _this.getPreviewComponent = function (type) {
      return type === 'extended' ? _TopicExtendedPreview2.default : _TopicPreview2.default;
    };
  ...
  _createClass(TopicsList, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['type', 'breakpointsStatus', 'topics', 'navigateTo', 'showAllAction']);
      ...
      var PreviewComponent = this.getPreviewComponent(type);
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(PreviewComponent, _extends({
                  navigateTo: function navigateTo() {
                    return _navigateTo(topic.basePath);
                  }
                }, topic))
              );
            })
...
TopicsList.propTypes = {
  ...
  topics: (0, _propTypes.arrayOf)(_propTypes.object).isRequired,
  type: (0, _propTypes.oneOf)(['default', 'extended'])
};
...
exports.default = (0, _consumeContainerQuery2.default)(TopicsList);