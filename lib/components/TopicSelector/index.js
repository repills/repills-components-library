  ...
  function TopicSelector(props) {
    ...
    _this.transformSelectedToObject = function (selected) {
      return selected.reduce(function (acc, e) {
        acc.push(_defineProperty({}, e, true));
        return acc;
      }, {});
    };
    ...
    _this.handleOnChange = function (id) {
      return function () {
        return _this.setState(function (state) {
          ...
          _this.props.handleOnChange({ selected: result });
    ...
    _this.state = {
      selected: _this.props.selected ? _this.transformSelectedToObject(_this.props.selected) : {}
    };
    return _this;
  }
              ...
              Object.entries(topics).map(function (_ref3, index) {
                ...
                return _react2.default.createElement(
                  ...
                  _react2.default.createElement(_index2.default, _extends({
                    checked: _this2.isChecked(topic.slug),
                    handleOnChange: _this2.handleOnChange(topic.slug)
                  }, topic))
                );
              })
            )
