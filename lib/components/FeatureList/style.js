...
var item = exports.item = (0, _styledComponents.css)(_templateObject2, (0, _utils.extRem)(12), (0, _utils.extRem)(12), neutral.low, function (props) {
  return props.skin === 'dark' && '\n    border-color: ' + (0, _polished.rgba)(neutral.higher, .4) + ';\n  ';
}, function (props) {
