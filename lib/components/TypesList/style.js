...
var item = exports.item = (0, _styledComponents.css)(_templateObject3, _styledComponentsGrid.grid.unit({ size: 4 / 10 }), _breakpoints.SM, _styledComponentsGrid.grid.unit({ size: 3 / 14 }), _breakpoints.MD, _styledComponentsGrid.grid.unit({ size: 3 / 17 }), _breakpoints.LG, _styledComponentsGrid.grid.unit({ size: 3 / 23 }));