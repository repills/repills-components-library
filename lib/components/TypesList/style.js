...
var item = exports.item = (0, _styledComponents.css)(_templateObject2, function (props) {
  return !props.breakpointsStatus[_breakpoints.SM] && (0, _styles.gridItem)(props.count, 1, halfGutter, '1px');
}, function (props) {
  return props.breakpointsStatus[_breakpoints.SM] && !props.breakpointsStatus[_breakpoints.LG] && (0, _styles.gridItem)(props.count, 2, gutter, '1px');
}, function (props) {
  return props.breakpointsStatus[_breakpoints.LG] && (0, _styles.gridItem)(props.count, 3, gutter, '1px');
});