...
var item = exports.item = (0, _styledComponents.css)(_templateObject2, function (props) {
  return !props.breakpointsStatus[_breakpoints.SM] && (0, _styles.gridItem)(props.count, 2, halfGutter, doubleGutter);
}, function (props) {
  return props.breakpointsStatus[_breakpoints.SM] && !props.breakpointsStatus[_breakpoints.LG] && (0, _styles.gridItem)(props.count, 4, gutter, doubleGutter);
}, function (props) {
  return props.breakpointsStatus[_breakpoints.LG] && (0, _styles.gridItem)(props.count, 8, gutter, doubleGutter);
});