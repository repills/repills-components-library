...
var item = exports.item = (0, _styledComponents.css)(_templateObject3, _styledComponentsGrid.grid.unit({ size: 1 }), halfGutter, halfGutter, _breakpoints.SM, _styledComponentsGrid.grid.unit({ size: 1 / 2 }), gutter, gutter, _breakpoints.MD, _styledComponentsGrid.grid.unit({ size: 1 / 3 }));