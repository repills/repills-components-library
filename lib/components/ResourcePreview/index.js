...
var ResourcePreview = function (_React$Component) {
  ...
  function ResourcePreview() {
    ...
    }, _this.handleNavigateToDetailPage = function (e) {
      e.preventDefault();
      e.stopPropagation();
      var _this$props2 = _this.props,
          slug = _this$props2.slug,
          publishedAt = _this$props2.publishedAt,
          navigateToDetail = _this$props2.navigateToDetail;

      navigateToDetail({ slug: slug, publishedAt: publishedAt });
  ...
  _createClass(ResourcePreview, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['color', 'title', 'author', 'link', 'createdAt', 'publishedAt', 'dateType', 'slug', 'generateDetailUrl', 'navigateToDetail', 'typeLabel']);
